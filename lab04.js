 ...
 **************************************************************************/
function genId(min = 9_000_000, max = 9_999_999) {
 ...
 **************************************************************************/
const studentObjects = students.map(genStudentObj);
// For testing:
 ...
 **************************************************************************/
const originalStudents = studentObjects.filter((E) => E['id'] < 9_200_000)
 ...
 **************************************************************************/
const firstStudent = studentObjects.reduce((accumulator, currentValue) => currentValue.id < accumulator.id ? currentValue : accumulator, studentObjects[0]);
 ...
 **************************************************************************/
const major = (theNumber) => theNumber % 2 === 0 ? "TCSS" : "TCES";
console.dir(major(9));
// 'TCES'
 ...
 **************************************************************************/
const setStudents = studentObjects.map((CurStudentObject) => ({ ...CurStudentObject, major: major(CurStudentObject['id']) }));
 ...
 **************************************************************************/
const countTcss = setStudents.reduce((accumulator, currentValue) => currentValue.major == "TCSS" ? accumulator + 1 : accumulator, 0);
